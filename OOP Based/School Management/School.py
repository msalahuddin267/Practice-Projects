class School:
    ...
    def __repr__(self) -> str:
        ...
        for student in eight.students:
            print(student.name)
        print(f'Total : {len(eight.students)}')

        print('------ Subjects & Teachers -------')
...
class ClassRoom:
    ...
    def take_final_exam(self):
        ...
        # claculate final grade
        for student in self.students:
            student.final_grade_calculate()

    def __str__(self) -> str:
        f'{self.name} --- {len(self.students)}'

    # TODO: Sort student with gpa
